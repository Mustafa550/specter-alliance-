...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(45deg, #ff9f1c, #ff5d8f);
            display: flex;
...
<div class="container" id="register-form">
    ...
    <div class="toggle-form">
        <p>Zaten hesabınız var mı? <a href="javascript:void(0);" onclick="toggleForms()">Giriş Yap</a></p>
    </div>
</div>
...
<script>
    ...
    // Kullanıcıları localStorage'a kaydetme
